"""
Visualizing Clustering Results and Data Embeddings
==================================================
...
from rm_classifier import prepare_data
import warnings
...
def plot_idx(plot_type, data_type, n_fft, n_time, suppress_dc):
    ...
    Args:
        plot_type (str): Type of plot ("fft", "phase", "time").
        data_type (str): Type of data ("time", "fft", "fft_phase", "fft_time").
        n_fft (int): Number of FFT bins.
        n_time (int): Number of time samples.
        suppress_dc (bool): Whether DC component is suppressed.
    
    Returns:
        tuple: (start_idx, end_idx) for slicing the data array.
    """
    if plot_type == "fft":
